                    ...
                    <div class="col-8">
                        ...
                        <form action="{{route('post.update',['id'=>$post->id])}}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="content" id="ckeditor" placeholder="Nhập mô tả">{{$post->content}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="file" name="image" class="form-control" id="example-fileinput" onchange="loadFile(event)" value="">
                                ...
                                <div class="col-lg-4">
                                    <img id="output" style="margin: auto; display: block;" src="{{asset('backend/post/'.$post->image)}}" alt="" height=150 width=200>
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-lg-2"></div>
                                <div class="col-lg-2"><input type="submit" class="btn btn-primary waves-effect width-md waves-light" value="Chỉnh sửa"></div>
