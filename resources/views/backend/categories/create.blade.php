...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4">Trang loại sản phẩm</h4>
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-8">
                        ...
                        @endif
                            <form action="{{route('categories.create')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Tên loại sản phẩm</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="categories_desc" rows="5" id="example-textarea" placeholder="Nhập mô tả"></textarea>
