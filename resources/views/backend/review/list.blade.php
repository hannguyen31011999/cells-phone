                    ...
                    @foreach($review as $value)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" onclick="confirm('Bạn muốn khuyến mãi này?');" class="btn btn-icon waves-effect waves-light btn-danger" style="margin-left: 5px;" title="Xóa bình luận"><i class="fas fa-trash-alt"></i></a>
                                @if($value->status==1)
