...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4">Trang chỉnh sửa attribute sản phẩm</h4>
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-8">
                        ...
                        @endif
                        @if(isset($attribute))
                        <form action="{{route('attribute_product.update',['id'=>$attribute->product_detail_id,'idAttribute'=>$attribute->id])}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="tags-default">
                                        <input type="text" value="{{$attribute->color}}" data-role="tagsinput" name="color">
                                    </div>
                                    @if($errors->has('color'))
                                        <div class="alert alert-danger">
                                            {{$errors->first('color')}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" name="price_attribute" class="form-control" value="{{$attribute->price_attribute}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" name="qty" class="form-control" value="{{$attribute->qty}}" placeholder="Nhập số lượng">
                                    @if($errors->has('qty'))
                                        <div class="alert alert-danger">
                                            {{$errors->first('qty')}}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="card" style="margin-top: 5px;">
                                        <div class="card-body">
                                            <div id="preview">
                                                <img src="{{asset('backend/attribute_img/'.$attribute->image)}}" id="image" height="150px" width="150px" style="margin-left:5px;border:1px solid #ccc!important;margin-bottom:5px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
