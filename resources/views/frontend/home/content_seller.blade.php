...
<div class="like-product ptb-95 off-white-bg pt-sm-50 pb-sm-55 ">
    <div class="container">
        <div class="like-product-area"> 
            <h3>Điện thoại bán chạy</h3>
            <!-- Arrivals Product Activation Start Here -->
            <div class="like-pro-active owl-carousel">
            @foreach($product as $products)
                @foreach($seller as $key => $productDetail)
                @if($productDetail->product_id==$products->id)
                ...
                <div class="double-product">
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            ...
                            @foreach($products->AttributeProducts as $key1 => $attributes)
                                @if($key==$key1)
